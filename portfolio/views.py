...
def index(request):
    ...
    ga.desc = "A python project to detect the real time objects on live video streaming using populat YOLO framework"
    ga.liveDemo = ''
    ...
    rel.desc = "Simple implementation and understanding of Random Forest algorithm with alongside python code."
